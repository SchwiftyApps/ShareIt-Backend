...
let package = Package(
    ...
    dependencies: [
	  ...
	  .package(url: "https://github.com/IBM-Swift/Kitura-OpenAPI", from: "1.0.0"),
	],
    targets: [
      .target(name: "ShareIt-Backend", dependencies: [ .target(name: "Application"), "Kitura" , "HeliumLogger"]),
